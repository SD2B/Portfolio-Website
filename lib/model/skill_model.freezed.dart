...
abstract class $SkillModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? name, String? svg});
}
...
class _$SkillModelImpl implements _SkillModel {
  const _$SkillModelImpl({this.id, this.name, this.svg});
  ...
  @override
  String toString() {
    return 'SkillModel(id: $id, name: $name, svg: $svg)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, svg);
...
abstract class _SkillModel implements SkillModel {
  const factory _SkillModel(
      {final int? id,
      final String? name,
      final String? svg}) = _$SkillModelImpl;
